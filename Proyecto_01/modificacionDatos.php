                    ...
                    <div class="card bg-light mx-2 my-2 px-2 py-2">
					    ...
					    <div id="invalid_boleta" class="invalid-feedback"><p></p></div>
                                ...
                                <div class="form-row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="date" id="fech-nac" name="fech-nac" class="form-control" value="<?php echo $fechaNacimiento ?>">
					    ...
					    <div id="invalid_curp" class="invalid-feedback"><p></p></div>
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <select name="entidad" class="form-control" id="entidad" required value="<?php echo '$estado' ?>">
